...
<section>
    ...
    <table class="table table-bordered table-striped table-condensed">
				<thead>
					<tr>
						<th class="leftLine" scope="col" rowspan="3">통화</th>
				...
				<tbody>
					<c:forEach items="${ currencyList }" var="cur">
						<tr>
							<td class="leftLine">${cur.currency}</td>
							<td class="ali">${cur.cashbuyrate}</td>
							<td class="ali">${cur.cashbuyspread}</td>
							<td class="ali">${cur.cashsellrate}</td>
							<td class="ali">${cur.cashsellspread}</td>
							<td class="ali">${cur.remittance}</td>
							<td class="ali">${cur.receive}</td>
							<td class="ali">${cur.tcbuy}</td>
							<td class="ali">${cur.fcsell}</td>
							<td class="ali">${cur.basicrate}</td>
							<td class="ali">${cur.conversion}</td>
							<td class="ali">${cur.usdrate}</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
